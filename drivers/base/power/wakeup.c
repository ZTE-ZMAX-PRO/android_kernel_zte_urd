...
#define ZTE_WAKELOCK_DEBUG //ZTE_PM_LHX_20140115 add to identify who enable/disable clks
#include <linux/module.h>

/*
How to debug?
first 
echo -n "wakelockname" > /sys/module/wakeup/parameters/wakelock_debug
then cat /proc/kmsg 
...
static void wakeup_source_activate(struct wakeup_source *ws)
{
    ...
    {
        //      printk("zte_clk %test\n",wakelock_debug_zte);
        if (strstr(ws->name,wakelock_debug_zte))
